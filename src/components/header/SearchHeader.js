...
function SearchHeader() {
    ...
    const handleSearchTermChange = (e) => {
        ...
        axios
            ...
            .then((res) => {
                setItemOnSearch(res.data.products);
            })
    ...
    const HandleHistorySearch = (props) => {
        const { history } = props;
                ...
                <ul className="search-items">
                    {history.map((item, index) => (
                        <li className="search-item" key={index}>
                            ...
                            >
                                <img src={item.image} alt="" width="35px" height="35px" />
    ...
    return (
        <div className="search__header">
            <div className="search__header-logo">
                <Link to="/">
                    <svg viewBox="0 0 192 65" className="header-logo-img">
                        <g fillRule="evenodd">
                            <path
                                fill="#fff"
            ...
            <div className="search__header-container">
                ...
                <div className="search__header-navbar">
                    <a href="">khẩu trang</a>
                    <a href="">Kem chống nắng</a>
                    <a href="">Nồi chiên không dầu</a>
                    <a href="">Balo</a>
                    <a href="">Đèn led trang trí</a>
                    <a href="">Áo dài</a>
                    <a href="">Kẹp tóc</a>
                    <a href="">Vòng tay</a>
                </div>
